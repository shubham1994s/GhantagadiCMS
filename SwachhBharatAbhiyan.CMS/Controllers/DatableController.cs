...
namespace SwachhBharatAbhiyan.CMS.Controllers
{
    public class DatableController : Controller
    {
        ...
        public string GetJqGridJson(string INSERT_ID,string draw, string start, string length, string rn, DateTime? fdate = null, DateTime? tdate = null, int userId = 0,string Vehicalnumber="", string clientName = null, int? param1 = null, int? param2 = null, int? param3 = null)
        {
            ...
            gridRepository = GetRepository(INSERT_ID,rn, searchValue, fdate, tdate, userId,Vehicalnumber, clientName, param1, param2);
        ...
        private IDataTableRepository GetRepository(string INSERT_ID,string RepositoryName, string searchString = "", DateTime? fdate = null, DateTime? tdate = null, int userId = 0, string Vehicalnumber = "", string clientId = null, int? param1 = null, int? param2 = null, int? param3 = null)
        {
            ...
            if (searchString != "" && searchString != null)
            {
                ...
                if (arr.Length >= 3)
                {
                    ...
                    { Vehicalnumber = Convert.ToString(arr[3]); }
                    else Vehicalnumber = "";
                    ...
                    if (arr.Length > 4)
                    { 
                        if (arr[4].ToString() != null && arr[4] != " " && arr[4].ToString() != string.Empty)
                    { searchString = Convert.ToString(arr[4]); }
                    else searchString = "";
                    }
                    if (arr.Length == 4)
                    {
                    ...
                    if (arr.Length > 6)
                    {
                        ...
                        { param2 = Convert.ToInt32(arr[6]); }
                        else param2 = null;
                    }
                    if (arr.Length > 7)
                    {
                        if (arr[7].ToString() != null && arr[7] != "0" && arr[7] != " " && arr[7].ToString() != string.Empty)
                        { param3 = Convert.ToInt32(arr[7]); }
                        else param3 = null;
                    }
