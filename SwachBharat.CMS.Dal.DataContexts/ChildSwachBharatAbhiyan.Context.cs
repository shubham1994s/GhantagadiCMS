...
namespace SwachBharat.CMS.Dal.DataContexts
{
    ...
    public partial class DevChildSwachhBharatNagpurEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_NewEmployeeSummary_Result> SP_NewEmployeeSummary(Nullable<System.DateTime> from, Nullable<System.DateTime> to, Nullable<int> userid, string vehicalNumber)
        {
            var fromParameter = from.HasValue ?
                new ObjectParameter("from", from) :
                new ObjectParameter("from", typeof(System.DateTime));
            ...
            var vehicalNumberParameter = vehicalNumber != null ?
                new ObjectParameter("vehicalNumber", vehicalNumber) :
                new ObjectParameter("vehicalNumber", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_NewEmployeeSummary_Result>("SP_NewEmployeeSummary", fromParameter, toParameter, useridParameter, vehicalNumberParameter);
        }
    }
}
